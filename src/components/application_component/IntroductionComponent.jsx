...
const Intro = () => {
  return (
    <div className="flex flex-col pb-11 lg:flex-row pt-[50px] px-[20px] lg:px-[220px]">
      ...
      <div className="flex-1 flex flex-col justify-center pl-0 lg:pl-[20px] text-center lg:text-left">
        ...
        The mission is to deliver unique cafe at affordable prices and we are the people to do it. 
        </p>
        <p className="text-2xl pt-[30px] md:text-3xl font-bold text-black mb-4">
        What makes us unique?
        </p>
        <p className="text-base md:text-lg text-gray-700">
        Our menu is developed by high level chefs and we are the only cafe in the area that offers a unique experience.
        </p>
      </div>
    </div>
  );
